...
NUM_ITEMS = 20
DODGE_BOARD_SIZE = 11
DODGE_NUM_RIGID = 36#DODGE_BOARD_SIZE * 2 # TODO leider immer nur manuel einstellbar
DODGE_NUM_WOOD = 36#DODGE_BOARD_SIZE * 2
DODGE_NUM_ITEMS = 20 #DODGE_BOARD_SIZE + 2
DODGE_NUM_BOMBS = 1
BOMB_BOARD_SIZE = 11
BOMB_NUM_RIGID = 0
BOMB_NUM_WOOD = BOMB_BOARD_SIZE * 6
BOMB_NUM_ITEMS = 0
